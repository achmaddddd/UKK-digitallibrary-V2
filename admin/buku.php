...
<tr>
    <td> Judul Buku </td>
    <td><input type="text" name="Judul" id="title" placeholder="Contoh: buto ijo"></td>
</tr>
<tr>
    <td> Penulis </td>
   <td> <input type="text" name="Penulis" id="title" placeholder="Contoh: bambang"></td>
</tr>
<tr>
    <td> Penerbit </td>
    <td><input type="text" name="Penerbit" id="title" placeholder="Contoh: pall production"></td>
</tr>
<tr>
    <td> Tahun Terbit </td>
